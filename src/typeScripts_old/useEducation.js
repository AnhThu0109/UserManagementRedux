...
import UserEducationDialog from './UserEducationDialog';
...
const UserEducation = (props): JSX.Element => {
  ...
  const { mutate: deleteSchool, isLoading: isDeleteLoading } = useDeleteSchool({
    onSuccess: () => {
      console.log('delete');
      setIsUpdate(true);
    }
